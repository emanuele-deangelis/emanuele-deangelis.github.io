...
new43(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q) :- M=<rat(-1,1), 
          new44(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q).
new43(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q) :- M>=rat(1,1), 
          new44(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q).
new43(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q) :- M=:=rat(0,1), 
          new46(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q).
new42(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q) :- 
          new43(A,B,C,D,E,F,G,H,I,J,K,L,R,N,O,P,Q).
new40(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q) :- R=:=rat(-1,1)+A, 
          S=:=rat(1,1)+E+F+G, T=:=rat(0,1), U=:=rat(0,1), A>=rat(1,1), 
          new4(R,B,C,D,S,T,U,H,I,J,K,L,M,N,O,P,Q).
new39(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q) :- N=<rat(-1,1), 
          new40(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q).
new39(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q) :- N>=rat(1,1), 
          new40(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q).
new39(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q) :- N=:=rat(0,1), 
          new42(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q).
new38(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q) :- 
          new39(A,B,C,D,E,F,G,H,I,J,K,L,M,R,O,P,Q).
new36(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q) :- R=:=rat(-1,1)+A, 
          S=:=rat(1,1)+B+C+D, T=:=rat(0,1), U=:=rat(0,1), A>=rat(1,1), 
          new4(R,S,T,U,E,F,G,H,I,J,K,L,M,N,O,P,Q).
new35(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q) :- O=<rat(-1,1), 
          new36(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q).
new35(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q) :- O>=rat(1,1), 
          new36(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q).
new35(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q) :- O=:=rat(0,1), 
          new38(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q).
new34(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q) :- 
          new35(A,B,C,D,E,F,G,H,I,J,K,L,M,N,R,P,Q).
new32(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q) :- R=:=rat(1,1)+C+D, S=:=rat(0,1), 
          T=:=rat(0,1), U=:=rat(-1,1)+E, E>=rat(1,1), 
          new4(A,R,S,T,U,F,G,H,I,J,K,L,M,N,O,P,Q).
new31(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q) :- P=<rat(-1,1), 
          new32(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q).
new31(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q) :- P>=rat(1,1), 
          new32(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q).
new31(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q) :- P=:=rat(0,1), 
          new34(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q).
...
new21(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q,R) :- A>=rat(1,1), 
          new23(B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q,R).
new19(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q) :- R=:=rat(1,1), F>=rat(0,1), 
          new21(R,A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q).
new19(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q) :- R=:=rat(0,1), F=<rat(-1,1), 
          new21(R,A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q).
...
new17(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q,R) :- A>=rat(1,1), 
          new19(B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q,R).
new15(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q) :- R=:=rat(1,1), G>=rat(0,1), 
          new17(R,A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q).
new15(A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q) :- R=:=rat(0,1), G=<rat(-1,1), 
          new17(R,A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q).
