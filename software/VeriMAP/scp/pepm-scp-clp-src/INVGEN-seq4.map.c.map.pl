...
new11(A,B,C,D,E,F,G,H) :- I=:=rat(-1,1)+E, J=:=rat(1,1)+G, A=<rat(-1,1), 
          new7(B,C,D,I,F,J,H).
new11(A,B,C,D,E,F,G,H) :- I=:=rat(-1,1)+E, J=:=rat(1,1)+G, A>=rat(1,1), 
          new7(B,C,D,I,F,J,H).
new8(A,B,C,D,E,F,G) :- H=:=rat(1,1), D>=rat(1,1), new11(H,A,B,C,D,E,F,G).
new8(A,B,C,D,E,F,G) :- H=:=rat(0,1), D=<rat(0,1), new11(H,A,B,C,D,E,F,G).
