...
new14(A,B,C,D,E) :- F=:=rat(1,1)+B, A=<rat(-1,1), new9(F,C,D,E).
new14(A,B,C,D,E) :- F=:=rat(1,1)+B, A>=rat(1,1), new9(F,C,D,E).
new11(A,B,C,D) :- E=:=rat(1,1)+A, A-C=<rat(-1,1), new11(E,B,C,D).
new11(A,B,C,D) :- E=:=rat(1,1)+B, A-C>=rat(0,1), new7(A,E,C,D).
new10(A,B,C,D) :- E=:=rat(1,1), B>=rat(1,1), new14(E,A,B,C,D).
new10(A,B,C,D) :- E=:=rat(0,1), B=<rat(0,1), new14(E,A,B,C,D).
