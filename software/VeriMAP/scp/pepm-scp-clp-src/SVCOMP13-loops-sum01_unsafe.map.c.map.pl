...
new6(A,B,C,D,E) :- B-rat(1,2)*D=<rat(-1,2), new8(A,B,C,D,E).
new5(A,B,C,D,E) :- F=:=rat(1,1)+A, G=:=rat(2,1)+D, A=<rat(9,1), new4(F,B,C,G,E).
new5(A,B,C,D,E) :- F=:=rat(1,1)+A, A>=rat(10,1), new4(F,B,C,D,E).
new4(A,B,C,D,E) :- A-B=<rat(0,1), new5(A,B,C,D,E).
